var B={},H=(N,C,L)=>(B.__chunk_535=(V,T,f)=>{"use strict";function v(e){let t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t}f.d(T,{b9:()=>D,FA:()=>b,_H:()=>n});function c(e){return btoa(String.fromCharCode(...new TextEncoder().encode(e))).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function E(e){return v(atob(e.replace(/-+(BEGIN|END).*/g,"").replace(/\s/g,"")))}async function o(e,t,i){return await crypto.subtle.importKey("raw",v(e),t,!0,i)}async function $(e,t,i){return await crypto.subtle.importKey("jwk",e,t,!0,i)}async function k(e,t,i){return await crypto.subtle.importKey("spki",E(e),t,!0,i)}async function w(e,t,i){return await crypto.subtle.importKey("pkcs8",E(e),t,!0,i)}async function A(e,t,i){if(typeof e=="object")return $(e,t,i);if(typeof e!="string")throw Error("Unsupported key type!");return e.includes("PUBLIC")?k(e,t,i):e.includes("PRIVATE")?w(e,t,i):o(e,t,i)}function g(e){let t=Array.from(atob(e),i=>i.charCodeAt(0));return JSON.parse(new TextDecoder("utf-8").decode(new Uint8Array(t)))}if(typeof crypto>"u"||!crypto.subtle)throw Error("SubtleCrypto not supported!");var S={none:{name:"none"},ES256:{name:"ECDSA",namedCurve:"P-256",hash:{name:"SHA-256"}},ES384:{name:"ECDSA",namedCurve:"P-384",hash:{name:"SHA-384"}},ES512:{name:"ECDSA",namedCurve:"P-521",hash:{name:"SHA-512"}},HS256:{name:"HMAC",hash:{name:"SHA-256"}},HS384:{name:"HMAC",hash:{name:"SHA-384"}},HS512:{name:"HMAC",hash:{name:"SHA-512"}},RS256:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-256"}},RS384:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-384"}},RS512:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-512"}}};async function m(e,t,i="HS256"){if(typeof i=="string"&&(i={algorithm:i}),i={algorithm:"HS256",header:{typ:"JWT",...i.header??{}},...i},!e||typeof e!="object")throw Error("payload must be an object");if(i.algorithm!=="none"&&(!t||typeof t!="string"&&typeof t!="object"))throw Error("secret must be a string, a JWK object or a CryptoKey object");if(typeof i.algorithm!="string")throw Error("options.algorithm must be a string");let r=S[i.algorithm];if(!r)throw Error("algorithm not found");e.iat||(e.iat=Math.floor(Date.now()/1e3));let s=`${c(JSON.stringify({...i.header,alg:i.algorithm}))}.${c(JSON.stringify(e))}`;if(i.algorithm==="none")return s;let a=t instanceof CryptoKey?t:await A(t,r,["sign"]),d=await crypto.subtle.sign(r,a,v(s));return`${s}.${btoa(function(h){let p="";for(let u=0;u<h.byteLength;u++)p+=String.fromCharCode(h[u]);return p}(new Uint8Array(d))).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}`}async function R(e,t,i="HS256"){var r,s,a;if(typeof i=="string"&&(i={algorithm:i}),i={algorithm:"HS256",clockTolerance:0,throwError:!1,...i},typeof e!="string")throw Error("token must be a string");if(i.algorithm!=="none"&&typeof t!="string"&&typeof t!="object")throw Error("secret must be a string, a JWK object or a CryptoKey object");if(typeof i.algorithm!="string")throw Error("options.algorithm must be a string");let d=e.split(".",3);if(d.length<2)throw Error("token must consist of 2 or more parts");let[h,p,u]=d,y=S[i.algorithm];if(!y)throw Error("algorithm not found");let l={header:g((r=e).split(".")[0].replace(/-/g,"+").replace(/_/g,"/")),payload:g(r.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"))};try{if(l.header?.alg!==i.algorithm)throw Error("INVALID_SIGNATURE");if(l.payload){let P=Math.floor(Date.now()/1e3);if(l.payload.nbf&&l.payload.nbf>P&&l.payload.nbf-P>(i.clockTolerance??0))throw Error("NOT_YET_VALID");if(l.payload.exp&&l.payload.exp<=P&&P-l.payload.exp>(i.clockTolerance??0))throw Error("EXPIRED")}if(y.name==="none")return l;let O=t instanceof CryptoKey?t:await A(t,y,["verify"]);if(!await crypto.subtle.verify(y,O,(a=u,v(atob(a.replace(/-/g,"+").replace(/_/g,"/").replace(/\s/g,"")))),(s=`${h}.${p}`,v(s))))throw Error("INVALID_SIGNATURE");return l}catch(O){if(i.throwError)throw O;return}}async function b(e,t){return await m(e,t)}async function I(e,t){try{return await R(e,t)}catch{throw Error("Invalid token")}}async function _(e){let t=new TextEncoder().encode(e);return Array.from(new Uint8Array(await crypto.subtle.digest("SHA-256",t))).map(i=>i.toString(16).padStart(2,"0")).join("")}async function D(e,t){return await _(e)===t}async function n(e){let t=e.headers.get("authorization");if(!t||!t.startsWith("Bearer "))throw Error("No token provided");let i=t.replace("Bearer ",""),r=await I(i,process.env.JWT_SECRET||"fallback-secret"),s=r.payload||r;if(!s.adminId||!s.username||!s.role)throw Error("Invalid token payload");return s}},B.__chunk_126=(V,T,f)=>{"use strict";f.d(T,{E:()=>D});class v{constructor(e){this.vehicleRepository=e}async getAvailableVehicles(e){if(e&&!this.isValidVehicleType(e))throw Error(`Invalid vehicle type: ${e}`);let t=await this.vehicleRepository.getAvailableVehicles(e);return this.sortVehiclesByPriority(t)}async getVehicleById(e){if(!e||e.trim()==="")throw Error("Vehicle ID is required");return this.vehicleRepository.getVehicleById(e)}async getVehicleCount(){return this.vehicleRepository.getVehicleCount()}async getVehiclesForAdmin(e){return this.vehicleRepository.getVehiclesByAdmin(e)}async createVehicle(e){this.validateVehicleData(e);let t=await this.vehicleRepository.createVehicle(e),i=await this.vehicleRepository.getVehicleById(t);if(!i)throw Error("Failed to create vehicle");return i}async updateVehicleAvailability(e,t){if(!e||e.trim()==="")throw Error("Vehicle ID is required");await this.vehicleRepository.updateVehicleAvailability(e,t);let i=await this.vehicleRepository.getVehicleById(e);return!!i&&i.isAvailable===t}isValidVehicleType(e){return["sedan","noah","hiace"].includes(e.toLowerCase())}validateVehicleData(e){if(!e.name||e.name.trim()==="")throw Error("Vehicle name is required");if(!e.type||!this.isValidVehicleType(e.type))throw Error("Valid vehicle type is required (sedan, noah, hiace)");if(!e.capacity||e.capacity<1)throw Error("Vehicle capacity must be at least 1");if(!e.pricePerDay||e.pricePerDay<0)throw Error("Price per day must be a positive number")}sortVehiclesByPriority(e){return e.sort((t,i)=>{let r=t.photos.some(a=>a.isPrimary),s=i.photos.some(a=>a.isPrimary);return r&&!s?-1:!r&&s?1:new Date(i.createdAt).getTime()-new Date(t.createdAt).getTime()})}async getAllVehicles(){return this.vehicleRepository.getAllVehicles()}async addVehiclePhoto(e,t){return this.vehicleRepository.addVehiclePhoto(e,t)}async setPrimaryPhoto(e,t){return this.vehicleRepository.setPrimaryPhoto(e,t)}async deleteVehiclePhoto(e){return this.vehicleRepository.deleteVehiclePhoto(e)}async updateVehicle(e,t){this.validateVehicleData(t),await this.vehicleRepository.updateVehicle(e,t);let i=await this.vehicleRepository.getVehicleById(e);if(!i)throw Error("Failed to fetch updated vehicle");return i}async deleteVehicle(e){if(!await this.vehicleRepository.getVehicleById(e))throw Error("Vehicle not found");return await this.vehicleRepository.deleteVehicle(e),!await this.vehicleRepository.getVehicleById(e)}}function c(n){let e=n.replace(/\D/g,"");return e.length===10&&!e.startsWith("880")||e.length===11&&e.startsWith("01")?`+880${e}`:n.startsWith("+")?n:`+${e}`}function E(n){let e=n.replace(/\D/g,"");return e.length>=10&&e.length<=15}function o(n){var e;return{name:(e=n.name||"")?e.trim().split(/\s+/).map(t=>{if(t.length<=2)return t;{if(t.length===3)return`${t[0]}*${t[2]}`;if(t.length===4)return`${t[0]}${t[1]}**${t[3]}`;let i=t.substring(0,2),r=t.substring(t.length-1),s=t.length-3;return`${i}${"*".repeat(s)}${r}`}}).join(" "):"",phone:function(t){if(!t)return"";let i=t.replace(/[^\d+]/g,"");if(i.startsWith("+880")&&i.length>=13){let r=i.substring(4,8),s=i.substring(i.length-2),a=i.length-6;return`+880${r}${"*".repeat(a)}${s}`}if(i.length>=8){let r=i.substring(0,4),s=i.substring(i.length-2),a=i.length-6;return`${r}${"*".repeat(a)}${s}`}if(i.length>=4){let r=i.substring(0,1),s=i.substring(i.length-1),a=i.length-2;return`${r}${"*".repeat(a)}${s}`}return t}(n.phone||""),email:function(t){if(!t)return"";let[i,r]=t.split("@");if(!i||!r)return t;if(i.length<=2)return`${i}@${r}`;let s=i.substring(0,2),a="*".repeat(i.length-2);return`${s}${a}@${r}`}(n.email||"")}}class ${constructor(e,t,i){this.bookingRepository=e,this.passengerRepository=t,this.vehicleRepository=i}async createBooking(e){this.validateBookingData(e);let t=null;if(e.vehicleId&&e.vehicleId!=="pending-assignment"){if(!(t=await this.vehicleRepository.getVehicleById(e.vehicleId)))throw Error("Vehicle not found");if(!t.isAvailable)throw Error("Vehicle is not available for booking")}let i=c(e.passengerPhone),r=await this.passengerRepository.findByPhone(i);return r?await this.passengerRepository.updatePassenger(r.id,{name:e.passengerName,email:e.passengerEmail||r.email}):r=await this.passengerRepository.create({phone:i,name:e.passengerName,email:e.passengerEmail,isVerified:!1}),await this.bookingRepository.create({passengerId:r.id,vehicleId:e.vehicleId||"pending-assignment",bookingDate:e.bookingDate,pickupTime:e.pickupTime,tripType:e.tripType,pickupLocation:e.pickupLocation,dropoffLocation:e.dropoffLocation,status:"pending"})}async getBookingById(e){return this.bookingRepository.findById(e)}async getBookings(e={}){return this.bookingRepository.findAll(e)}async getBookingsByPassengerPhone(e){let t=c(e),i=await this.passengerRepository.findByPhone(t);return i?this.bookingRepository.findByPassengerId(i.id):[]}async updateBookingStatus(e,t){if(!await this.bookingRepository.findById(e))throw Error("Booking not found");return this.bookingRepository.updateStatus(e,t)}async updateBooking(e,t){if(!await this.bookingRepository.findById(e))throw Error("Booking not found");return await this.bookingRepository.updateBooking(e,t),this.bookingRepository.findById(e)}async cancelBooking(e,t){let i=await this.bookingRepository.findById(e);if(!i)throw Error("Booking not found");if(i.status==="cancelled")throw Error("Booking is already cancelled");if(i.status==="completed")throw Error("Cannot cancel completed booking");return this.bookingRepository.updateBooking(e,{status:"cancelled",notes:t?`Cancelled: ${t}`:"Cancelled by user"})}async getBookingStats(){let{bookings:e}=await this.bookingRepository.findAll({limit:1e3}),t={total:e.length,pending:0,confirmed:0,completed:0,cancelled:0};return e.forEach(i=>{switch(i.status){case"pending":t.pending++;break;case"confirmed":t.confirmed++;break;case"completed":t.completed++;break;case"cancelled":t.cancelled++}}),t}validateBookingData(e){if(!e.bookingDate)throw Error("Booking date is required");if(!e.pickupTime)throw Error("Pickup time is required");if(!e.tripType)throw Error("Trip type is required");if(!e.pickupLocation)throw Error("Pickup location is required");if(e.tripType==="round"&&!e.dropoffLocation)throw Error("Drop-off location is required for round trip");if(!e.passengerName)throw Error("Passenger name is required");if(!e.passengerPhone)throw Error("Passenger phone is required");if(!E(e.passengerPhone))throw Error("Invalid phone number format");if(e.passengerEmail&&!/\S+@\S+\.\S+/.test(e.passengerEmail))throw Error("Invalid email format");if(!e.vehicleId)throw Error("Vehicle selection is required");let t=new Date(e.bookingDate),i=new Date;if(i.setHours(0,0,0,0),t<i)throw Error("Booking date cannot be in the past")}async checkAvailability(e,t){let i=await this.vehicleRepository.getVehicleById(e);return!!i&&!!i.isAvailable}async getBookingsByVehicleId(e){return this.bookingRepository.findByVehicleId(e)}async getBookingByIdMasked(e){let t=await this.bookingRepository.findById(e);return t?(t.passenger&&(t.passenger={...t.passenger,name:o(t.passenger).name,phone:o(t.passenger).phone,email:o(t.passenger).email}),t):null}async getBookingsByPassengerIdMasked(e){return(await this.bookingRepository.findByPassengerId(e)).map(t=>(t.passenger&&(t.passenger={...t.passenger,name:o(t.passenger).name,phone:o(t.passenger).phone,email:o(t.passenger).email}),t))}async getAllBookingsMasked(e={}){let{bookings:t,total:i}=await this.bookingRepository.findAll(e);return{bookings:t.map(r=>(r.passenger&&(r.passenger={...r.passenger,name:o(r.passenger).name,phone:o(r.passenger).phone,email:o(r.passenger).email}),r)),total:i}}}class k{constructor(e,t){this.passengerRepository=e,this.bookingRepository=t}async createPassenger(e){if(!E(e.phone))throw Error("Invalid phone number format");let t=c(e.phone);if(await this.passengerRepository.findByPhone(t))throw Error("Passenger with this phone number already exists");if(e.email&&!/\S+@\S+\.\S+/.test(e.email))throw Error("Invalid email format");return this.passengerRepository.create({phone:t,name:e.name,email:e.email,isVerified:!1})}async getPassengerById(e){return this.passengerRepository.findById(e)}async getPassengerByPhone(e){let t=c(e);return this.passengerRepository.findByPhone(t)}async getPassengers(e={}){return this.passengerRepository.findAll(e)}async getPassengersWithBookings(e={}){let{passengers:t,total:i}=await this.passengerRepository.findAll(e);return{passengers:await Promise.all(t.map(async r=>{let s=await this.bookingRepository.findByPassengerId(r.id);return{...r,bookings:s.map(a=>({id:a.id,bookingDate:a.bookingDate,status:a.status,vehicle:{name:a.vehicle.name,type:a.vehicle.type}}))}})),total:i}}async updatePassenger(e,t){if(!await this.passengerRepository.findById(e))throw Error("Passenger not found");if(t.email&&!/\S+@\S+\.\S+/.test(t.email))throw Error("Invalid email format");if(!await this.passengerRepository.updatePassenger(e,t))throw Error("Failed to update passenger");return this.passengerRepository.findById(e)}async verifyPassenger(e){let t=c(e);if(!await this.passengerRepository.findByPhone(t))throw Error("Passenger not found");return this.passengerRepository.updateVerificationStatus(t,!0)}async unverifyPassenger(e){let t=c(e);if(!await this.passengerRepository.findByPhone(t))throw Error("Passenger not found");return this.passengerRepository.updateVerificationStatus(t,!1)}async deletePassenger(e){if(!await this.passengerRepository.findById(e))throw Error("Passenger not found");return this.passengerRepository.deletePassenger(e)}async passengerExists(e){let t=c(e);return this.passengerRepository.existsByPhone(t)}async getPassengerStats(){return this.passengerRepository.getStats()}async findOrCreatePassenger(e){let t=c(e.phone),i=await this.passengerRepository.findByPhone(t);return i?((e.name||e.email)&&(await this.passengerRepository.updatePassenger(i.id,{name:e.name||i.name,email:e.email||i.email}),i=await this.passengerRepository.findById(i.id)),i):this.createPassenger(e)}async searchPassengers(e,t={}){let{passengers:i,total:r}=await this.getPassengers({page:1,limit:1e3}),s=i.filter(p=>p.name?.toLowerCase().includes(e.toLowerCase())||p.phone.includes(e)||p.email?.toLowerCase().includes(e.toLowerCase())),{page:a=1,limit:d=10}=t,h=(a-1)*d;return{passengers:s.slice(h,h+d),total:s.length}}async getPassengerByIdMasked(e){let t=await this.passengerRepository.findById(e);return t?{...t,name:o(t).name,phone:o(t).phone,email:o(t).email}:null}async getPassengerByPhoneMasked(e){let t=c(e),i=await this.passengerRepository.findByPhone(t);return i?{...i,name:o(i).name,phone:o(i).phone,email:o(i).email}:null}async getPassengersMasked(e={}){let{passengers:t,total:i}=await this.passengerRepository.findAll(e);return{passengers:t.map(r=>({...r,name:o(r).name,phone:o(r).phone,email:o(r).email})),total:i}}}var w=f(535);class A{constructor(e){this.adminRepository=e}async authenticate(e,t){let i=await this.adminRepository.findByUsername(e);if(!i)return null;let r=await this.getAdminWithPassword(e);if(!r||!await(0,w.b9)(t,r.password))return null;await this.adminRepository.updateLastLogin(i.id);let s=await(0,w.FA)({adminId:i.id,username:i.username,role:i.role},process.env.JWT_SECRET||"fallback-secret");return{admin:i,token:s}}async getAdminWithPassword(e){return this.adminRepository.findByUsernameWithPassword(e)}async getAdminById(e){return this.adminRepository.findById(e)}}var g=f(3993);class S{async getDashboardStats(){let[e,t,i,r]=await Promise.all([this.database.query("SELECT COUNT(*) as count FROM bookings",[]),this.database.query("SELECT COUNT(*) as count FROM bookings WHERE status = $1",["pending"]),this.database.query("SELECT COUNT(*) as count FROM vehicles",[]),this.database.query("SELECT COUNT(*) as count FROM passengers",[])]);if(!e.success||!t.success||!i.success||!r.success)throw Error("Failed to fetch dashboard statistics");return{totalBookings:e.data?.[0]?.count||0,pendingBookings:t.data?.[0]?.count||0,totalVehicles:i.data?.[0]?.count||0,totalPassengers:r.data?.[0]?.count||0}}constructor(){this.database=g._.getDefaultProvider()}}class m{constructor(e){this.db=e}async executeQuery(e,t=[]){return this.db.query(e,t)}async select(e,t=[]){let i=await this.executeQuery(e,t);if(!i.success)throw Error(i.error||"Query failed");return i.data||[]}async insert(e,t=[]){let i=await this.executeQuery(e,t);if(!i.success)throw Error(i.error||"Insert failed");return i.meta?.last_row_id||0}async update(e,t=[]){let i=await this.executeQuery(e,t);if(!i.success)throw Error(i.error||"Update failed");return i.meta?.changes||0}async delete(e,t=[]){let i=await this.executeQuery(e,t);if(!i.success)throw Error(i.error||"Delete failed");return i.meta?.changes||0}}class R extends m{async getAvailableVehicles(e){let t=`
      SELECT v.*, 
             GROUP_CONCAT(
    ...
    `,i=crypto.randomUUID(),r=new Date;return await this.insert(t,[i,e.passengerId,e.vehicleId,e.bookingDate.toISOString(),e.pickupTime,e.tripType,e.pickupLocation,e.dropoffLocation||null,e.status,e.notes||null,r.toISOString(),r.toISOString()]),this.findById(i)}async findById(e){let t=`
      ...
      WHERE b.id = $1
    `,i=await this.select(t,[e]);return i.length===0?null:this.mapBookingResult(i[0])}async findAll(e={}){let{status:t,page:i=1,limit:r=10}=e,s="",a=[];t&&(s="WHERE b.status = $1",a.push(t));let d=`
      SELECT 
        b.*,
        p.id as passenger_id, p.phone as passenger_phone, p.name as passenger_name, 
        p.email as passenger_email, p.isVerified as passenger_isVerified,
    ...
    `,h=`
      ...
      FROM bookings b
      ${s}
    `,[p,u]=await Promise.all([this.select(d,[...a,r,(i-1)*r]),this.select(h,a)]),y=u[0]?.total||0;return{bookings:p.map(l=>this.mapBookingResult(l)),total:y}}async findByPassengerId(e){let t=`
      SELECT 
        b.*,
        p.id as passenger_id, p.phone as passenger_phone, p.name as passenger_name, 
        p.email as passenger_email, p.isVerified as passenger_isVerified,
    ...
    `,h=`
      ...
      FROM passengers
      ${s}
    `,[p,u]=await Promise.all([this.select(d,[...a,i,(t-1)*i]),this.select(h,a)]),y=u[0]?.total||0;return{passengers:p.map(l=>this.mapPassengerResult(l)),total:y}}async updatePassenger(e,t){let i=[],r=[],s=1;if(t.name!==void 0&&(i.push(`name = $${s}`),r.push(t.name),s++),t.email!==void 0&&(i.push(`email = $${s}`),r.push(t.email),s++),t.isVerified!==void 0&&(i.push(`isVerified = $${s}`),r.push(t.isVerified),s++),i.length===0)return!1;i.push(`updatedAt = $${s}`),r.push(new Date().toISOString()),s++,r.push(e);let a=`UPDATE passengers SET ${i.join(", ")} WHERE id = $${s}`;return await this.update(a,r)>0}async updateVerificationStatus(e,t){let i=`
      UPDATE passengers 
    ...
    `,i=await this.select(t,[e]);return i.length===0?null:i[0]}async updateLastLogin(e){let t=`
      ...
      SET updatedAt = $1
      WHERE id = $2
    `;return await this.update(t,[new Date().toISOString(),e])>0}mapAdminResult(e){return{id:e.id,username:e.username,email:e.email,phone:e.phone,role:e.role,createdAt:new Date(e.createdAt),updatedAt:new Date(e.updatedAt)}}}class D{static{this.vehicleService=null}static{this.bookingService=null}static{this.passengerService=null}static{this.adminService=null}static{this.adminStatsService=null}static getVehicleService(){if(!this.vehicleService){let e=new R(g._.getDefaultProvider());this.vehicleService=new v(e)}return this.vehicleService}static getBookingService(){if(!this.bookingService){let e=g._.getDefaultProvider(),t=new b(e),i=new I(e),r=new R(e);this.bookingService=new $(t,i,r)}return this.bookingService}static getPassengerService(){if(!this.passengerService){let e=g._.getDefaultProvider(),t=new I(e),i=new b(e);this.passengerService=new k(t,i)}return this.passengerService}static getAdminService(){if(!this.adminService){let e=new _(g._.getDefaultProvider());this.adminService=new A(e)}return this.adminService}static getAdminStatsService(){return this.adminStatsService||(this.adminStatsService=new S),this.adminStatsService}static reset(){this.vehicleService=null,this.bookingService=null,this.passengerService=null,this.adminService=null,this.adminStatsService=null}}},B);export{H as __getNamedExports};
